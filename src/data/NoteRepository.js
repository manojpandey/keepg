...
class NoteRepository extends EventEmitter {
  constructor () {
    ...
    this.ref = new Firebase('https://keepg.firebaseio.com/notes') // will have same result as new Firebase('https://keepg.firebaseio.com/').child('notes')
  ...
  update ({key, title = '', content = ''}, onComplete) {
    ...
    // this.ref.child(key) will create new reference like this new Firebase(`https://keepg.firebaseio.com/notes/${key}`)
  }
  // removes a note
